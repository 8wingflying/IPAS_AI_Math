...
- **Hyperopt** | TPE
  ...
  - 2015 [Hyperopt: A Python library for model selection and hyperparameter optimization](https://www.researchgate.net/publication/282814671_Hyperopt_A_Python_library_for_model_selection_and_hyperparameter_optimization)
